...
pub static PROVIDERS: &[OAuthProvider] = &[
    OAuthProvider {
        ...
        default_scopes: "https://www.googleapis.com/auth/calendar https://www.googleapis.com/auth/gmail.readonly https://www.googleapis.com/auth/drive.readonly https://www.googleapis.com/auth/userinfo.email",
    ...
    OAuthProvider {
        ...
        default_scopes: "User.Read Mail.Read Calendars.Read Files.Read openid email profile offline_access",
